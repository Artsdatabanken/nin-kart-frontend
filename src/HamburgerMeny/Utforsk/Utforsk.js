  ...
  */
  ...
  return (
    <>
      <Menyelement
        onClick={e => {
          the_props.onNavigate("/Natur_i_Norge/Natursystem");
          onToggleHovedmeny();
        }}
        icon={
          <img
      ...
      <Menyelement
        onClick={e => {
          the_props.onNavigate("/Natur_i_Norge/Landskap");
          onToggleHovedmeny();
        }}
        icon={<Landscape />}
        primary="Landskap"
      ...
      <Menyelement
        onClick={e => {
          the_props.onNavigate("/Administrativ_grense/");
          onToggleHovedmeny();
        }}
        icon={
          <img
      ...
      <Menyelement
        onClick={e => {
          the_props.onNavigate("/Naturvernområde/");
          onToggleHovedmeny();
        }}
        icon={<Naturvern />}
